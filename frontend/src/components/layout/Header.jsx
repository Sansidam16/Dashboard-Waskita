  ...
  return (
    <header className="bg-white shadow flex items-center justify-between px-6 py-4 border-b border-gray-200">
      ...
      <div className="flex items-center space-x-4">
        {/* Tampilkan username */}
        <span className="bg-accent text-white rounded-full px-3 py-1 font-medium flex items-center gap-1">
  <span>{username || 'User'}</span>
  {username && (
    <span className="text-teal-400 align-middle hover:scale-110 hover:drop-shadow transition-transform" title="User Aktif">
      <FaUserShield />
    </span>
  )}
</span>
