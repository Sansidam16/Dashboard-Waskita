...
export default function Register() {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md flex flex-col items-center">
        ...
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="w-full bg-green-600 text-white py-2 rounded-lg shadow-md hover:bg-green-700 transition font-semibold flex items-center justify-center gap-2"> 
  ...
  className="w-full mt-4 bg-blue-600 text-white py-2 rounded-lg shadow-md hover:bg-blue-700 transition font-semibold flex items-center justify-center gap-2"
>
